...
public class SubpruebaEntidad {
	...
	public SubpruebaEntidad() {}
	public SubpruebaEntidad(String nombre, List<Reactivo> reactivos, int puntuacionNatural, int puntuacionEscalar,
			boolean esOpcional) {
		super();
		this.nombre = nombre;
